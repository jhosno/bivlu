...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" id="numero-paginas" onkeypress="return event.which>=48 && event.which<=57" name="numero_paginas" type="number" min="20" max="2000" title="Ingrese el número de páginas con que cuenta el libro." placeholder="Ej. 451" required> 
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
 ...
 <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                               <input class="form-control" onkeypress="return event.which>=48 && event.which<=57" title="Ingrese el código propio del primer ejemplar." placeholder="Ej. 2132" name="correlativo" type="text"  value="{{ isset($libro) ? $libro['portada'] : '' }}" id = "correlative"required value="onchange.uniqid()"> 

                            </div>
                           
                       
                            <label for="libro" class=" control-label col-md-3">Resumen: <b style="color:red">*</b></label>
                            <div class="col-md-3">
                                <textarea class="form-control col-md-3" cols="2" rows="2"  name="resumen"  title="Ingrese el resumen del libro." placeholder="Ej. loren ipsum" required> </textarea>
...
function uniqid(){
    ...
    UUID = libro[0] + libro[1] + autor[0] + autor[1] + anioEdicion[0] + anioEdicion[1] + numeroPaginas[0] + numeroPaginas[1] + "-" + 01;
    console.log(UUID);
    return UUID;
}();
</script>
