...
<ul class="breadcrumb">
    ...
    <li><a href="javascript:history.back();">Historial de Préstamos</a></li> 
...
@foreach($data as $value)
                <tr>
                    ...
                    <td>{{ $value['loan']['fecha_devuelto'] }}</td>
...
function cancelar(id)
{
  $.confirm({
    ...
    content : 'Sólo confirme si ya no necesita el ejemplar solicitado.',
    buttons: {
      confirm:
      { 
        text:'Confirmar',
