...
<div class="row">
        <div class="col-md-6">
            <label for="titulo" style="text-align:right; float:right;">Incorporado en el año:</label>
        </div>
        <div class="col-md-6">
...
<div class="row">
                       <div class="col-md-3">
                        <label for="incorporacion_entre" style="text-align:right; float:right;">Desde</label> 
                       </div>
                       <div class="col-md-3">
                        <input required id="incorporacion_desde" name="incorporacion_desde" class="form-control intervalo_incorporacion" disabled/> 
                       </div>
                       <div class="col-md-3"> 
                        <label for="anio_entre" id="incorporacion_hasta"  style="text-align:right; float:right;">Hasta</label>
                       </div>
                       <div class="col-md-3">
                       <input required id="incorporacion_hasta" name="incorporacion_hasta" class="form-control intervalo_incorporacion" disabled/>
                       </div>
</div>
<div class="row">
                       <div class="col-md-3"><label style="text-align:right; float:right;" for="anio_exactamente">Exactamente</label></div>
                       <div class="col-md-9"><input name="incorporacion_exactamente" required class="form-control incorporacion_exactamente" name="incorporacion_exactamente" disabled/></div>
</div> 
<div class="row">
  ...
  $(function(){
    ...
    $('#anio').on('change',function(){
     ...
     $('#incorporacion').on('change',function(){
      if($(this).val()==='Definido por intervalo')
      {
        $('.intervalo_incorporacion').removeAttr('disabled');
        $('.incorporacion_exactamente').attr('disabled','disabled');
      }
      if($(this).val()==='Exactamente:')
      {
        $('.incorporacion_exactamente').removeAttr('disabled');
        $('.intervalo_incorporacion').attr('disabled','disabled');
      }
    });
  });
</script>